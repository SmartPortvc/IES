      ...
      <AuthProvider>
        <Suspense fallback={<LoadingSpinner fullScreen message="Loading application..." />}>
          <Routes>
            ...
            <Route path="/port-registration/:portId" element={<PortRegistration />} />
            <Route path="/hod-registration/:hodId" element={<HodRegistration />} />
            ...
            <Route path="/manage-cargo-types" element={
              <ProtectedRoute requiredRole="admin">
                <ManageCargoTypes />
              </ProtectedRoute>
            } />
            ...
            <Route path="/hod/vessels" element={
              <ProtectedRoute requiredRole="hod">
                <VesselsPage />
              </ProtectedRoute>
            } />
            ...
            {/* Port Routes */}
            <Route path="/port-dashboard" element={
              <ProtectedRoute requiredRole="port">
                <PortDashboard />
              </ProtectedRoute>
            } />

            <Route path="/port-profile" element={
              <ProtectedRoute requiredRole="port">
                <PortProfile />
              </ProtectedRoute>
            } />

            <Route path="/add-vessel" element={
              <ProtectedRoute requiredRole="port">
                <AddVessel />
              </ProtectedRoute>
            } />
            ...
            <Route path="/port-details/:portId" element={
              <ProtectedRoute allowedRoles={['admin', 'hod']}>
                <PortDetailsView />
              </ProtectedRoute>
            } />

            <Route path="/vessel-list/:portId" element={
              <ProtectedRoute allowedRoles={['admin', 'hod', 'port']}>
                <VesselList />
              </ProtectedRoute>
            } />

            <Route path="/vessel-details/:vesselId" element={
              <ProtectedRoute allowedRoles={['admin', 'hod', 'port']}>
                <VesselDetails />
              </ProtectedRoute>
            } />
            ...
            <Route path="/cargo-handled" element={
              <ProtectedRoute allowedRoles={['admin', 'hod']}>
                <CargoHandled />
              </ProtectedRoute>
            } />
