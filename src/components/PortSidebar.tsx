...
import { Ship, LogOut, PlusCircle, Anchor, ChevronLeft, ChevronRight } from 'lucide-react';
      ...
      <div className="flex-1 px-4 py-6">
        ...
        <button
          ...
          className={`flex items-center ${collapsed ? 'justify-center' : 'space-x-3'} w-full px-4 py-3 rounded-lg mb-2 transition-colors ${
            isActive('/port-profile') ? 'bg-seagreen-700' : 'hover:bg-seagreen-700/50'
          }`}
        ...
        <button
          ...
          className={`flex items-center ${collapsed ? 'justify-center' : 'space-x-3'} w-full px-4 py-3 rounded-lg mb-2 transition-colors ${
            isActive('/add-vessel') ? 'bg-seagreen-700' : 'hover:bg-seagreen-700/50'
          }`}
          title="Add Vessel"
        >
